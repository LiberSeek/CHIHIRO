...
<script setup lang="ts">
    ...
    import packageInfo from '@renderer/package-info'
    ...
    import { uptime } from '@chihiro/im-native/host'
    import { loadJsonMap } from '@renderer/function/utils/appUtil'
    import { backend } from '@renderer/runtime/backend'
    import RawMsgRenderPreviewPan from '@renderer/components/user/UserRawMsgRenderPreviewPan.vue'
