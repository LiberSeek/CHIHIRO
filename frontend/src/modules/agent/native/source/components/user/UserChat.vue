...
import StyledMenu from "@/modules/agent/native/source/components/shared/StyledMenu.vue";
import ProjectDialog, {
  type ProjectFormData,
} from "@/modules/agent/native/source/components/chat/ProjectDialog.vue";
import ProjectList, { type Project } from "@/modules/agent/native/source/components/chat/ProjectList.vue";
import ProjectView from "@/modules/agent/native/source/components/chat/ProjectView.vue";
import ChatInput from "@/modules/agent/native/source/components/chat/ChatInput.vue";
import ChatMessageList from "@/modules/agent/native/source/components/chat/ChatMessageList.vue";
import ChatUILogo from "@/modules/agent/native/source/components/chat/ChatUILogo.vue";
import type { RegenerateModelSelection } from "@/modules/agent/native/source/components/chat/RegenerateMenu.vue";
import ReasoningSidebar from "@/modules/agent/native/source/components/chat/ReasoningSidebar.vue";
import ThreadPanel from "@/modules/agent/native/source/components/chat/ThreadPanel.vue";
import WorkspaceFilesPanel from "@/modules/agent/native/source/components/chat/WorkspaceFilesPanel.vue";
import RefsSidebar from "@/modules/agent/native/source/components/chat/message_list_comps/RefsSidebar.vue";
import { useSessions, type Session } from "@/modules/agent/native/source/composables/useSessions";
import {
  ...
  type MessagePart,
  type TransportMode,
} from "@/modules/agent/native/source/composables/useMessages";
import { useMediaHandling } from "@/modules/agent/native/source/composables/useMediaHandling";
import { useRecording } from "@/modules/agent/native/source/composables/useRecording";
import { useProjects } from "@/modules/agent/native/source/composables/useProjects";
...
import {
  ...
  useLanguageSwitcher,
  useModuleI18n,
} from "@/modules/agent/native/source/i18n/composables";
import type { Locale } from "@/modules/agent/native/source/i18n/types";
import { askForConfirmation, useConfirmDialog } from "@/modules/agent/native/source/utils/confirmDialog";
import {
  contextLimit,
  formatTokenCount,
  type ProviderModelMetadata,
  type ProviderMetadataSource,
} from "@/modules/agent/native/source/utils/providerMetadata";
import { useToast } from "@/modules/agent/native/source/utils/toast";
