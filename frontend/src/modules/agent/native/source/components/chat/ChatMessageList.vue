...
import { fileApi } from "@/modules/agent/native/source/api/v1";
import RegenerateMenu, {
  type RegenerateModelSelection,
} from "@/modules/agent/native/source/components/chat/RegenerateMenu.vue";
import ThreadedMarkdownMessagePart from "@/modules/agent/native/source/components/chat/ThreadedMarkdownMessagePart.vue";
import ReasoningBlock from "@/modules/agent/native/source/components/chat/message_list_comps/ReasoningBlock.vue";
import ToolCallCard from "@/modules/agent/native/source/components/chat/message_list_comps/ToolCallCard.vue";
import ToolCallItem from "@/modules/agent/native/source/components/chat/message_list_comps/ToolCallItem.vue";
import IPythonToolBlock from "@/modules/agent/native/source/components/chat/message_list_comps/IPythonToolBlock.vue";
import RefsSidebar from "@/modules/agent/native/source/components/chat/message_list_comps/RefsSidebar.vue";
import ActionRef from "@/modules/agent/native/source/components/chat/message_list_comps/ActionRef.vue";
import MarkdownMessagePart from "@/modules/agent/native/source/components/chat/message_list_comps/MarkdownMessagePart.vue";
...
} from "@/modules/agent/native/source/components/chat/chatMarkdownComponents";
import {
  attachmentName,
  attachmentPresentation,
} from "@/modules/agent/native/source/components/chat/attachmentPresentation";
import {
...
import { useI18n, useModuleI18n } from "@/modules/agent/native/source/i18n/composables";
import { copyToClipboard } from "@/modules/agent/native/source/utils/clipboard";
