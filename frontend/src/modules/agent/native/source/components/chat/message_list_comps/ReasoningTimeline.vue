...
import { MARKDOWN_RENDER_MAX_LIVE_NODES } from "@/modules/agent/native/source/components/chat/markdownRenderConfig";
...
import type { MessagePart } from "@/modules/agent/native/source/composables/useMessages";
