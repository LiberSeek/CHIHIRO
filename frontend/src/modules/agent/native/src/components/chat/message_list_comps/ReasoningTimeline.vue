...
import { MARKDOWN_RENDER_MAX_LIVE_NODES } from "@/modules/agent/native/src/components/chat/markdownRenderConfig";
...
import type { MessagePart } from "@/modules/agent/native/src/composables/useMessages";
