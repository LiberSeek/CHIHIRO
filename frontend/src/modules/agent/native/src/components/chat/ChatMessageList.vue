...
import { fileApi } from "@/modules/agent/native/src/api/v1";
import RegenerateMenu, {
  type RegenerateModelSelection,
} from "@/modules/agent/native/src/components/chat/RegenerateMenu.vue";
import ThreadedMarkdownMessagePart from "@/modules/agent/native/src/components/chat/ThreadedMarkdownMessagePart.vue";
import ReasoningBlock from "@/modules/agent/native/src/components/chat/message_list_comps/ReasoningBlock.vue";
import ToolCallCard from "@/modules/agent/native/src/components/chat/message_list_comps/ToolCallCard.vue";
import ToolCallItem from "@/modules/agent/native/src/components/chat/message_list_comps/ToolCallItem.vue";
import IPythonToolBlock from "@/modules/agent/native/src/components/chat/message_list_comps/IPythonToolBlock.vue";
import RefsSidebar from "@/modules/agent/native/src/components/chat/message_list_comps/RefsSidebar.vue";
import ActionRef from "@/modules/agent/native/src/components/chat/message_list_comps/ActionRef.vue";
import MarkdownMessagePart from "@/modules/agent/native/src/components/chat/message_list_comps/MarkdownMessagePart.vue";
...
} from "@/modules/agent/native/src/components/chat/chatMarkdownComponents";
import {
  attachmentName,
  attachmentPresentation,
} from "@/modules/agent/native/src/components/chat/attachmentPresentation";
import {
...
import { copyToClipboard } from "@/modules/agent/native/src/utils/clipboard";
