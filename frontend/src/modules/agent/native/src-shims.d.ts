...
declare module '@/modules/agent/native/src/utils/toast' {
...
declare module '@/modules/agent/native/src/utils/providerUtils' {
...
declare module '@/modules/agent/native/src/utils/shikiLimitedBundle' {
